...
load('machineLearningModels.mat','omdl1s','omdl2','net1','omdl3');
...
disp('outer hair cells estimating...')
    ...
    for j = 1:size(difnorm)
        if difnorm(j,1) > 11
            ...
            if dnum == 1
                ...
                param = ObtainPixelValuesAround(xyz3,linearizedIm2);
                temppred = predict(omdl3,param);
            ...
            elseif dnum == 2
                ...
                param1_1 = ObtainPixelValuesAround(xyz3(1,:),linearizedIm2);
                param1_2 = ObtainPixelValuesAround(xyz3(2,:),linearizedIm2);
                temppred = predict(omdl3,[param1_1; param1_2]);
                ...
                for kk = 1:100
                    ...
                    rparam2 = ObtainPixelValuesAround(nextxyz,linearizedIm2);
                    temppred = predict(omdl3,rparam2);
...
tempparam = zeros(size(add4,1),64);
for i = 1:size(add4,1)
    tempparam(i,:) = ObtainPixelValuesAround(add4(i,:),linearizedIm2);
end
temppred = predict(omdl3,tempparam);
add4(temppred==1,:)=[];
